...
class AuthControllerTest {
    ...
    void testSignIn() throws Exception {
        ...
        SignInResponseDto response = new SignInResponseDto(true, user.getName());

        webTestClient.post().uri("/gateway-management/api/autenticacao")
    ...
    void testSignInWithError() throws Exception {
        ...
        when(authenticationManager.authenticate(any(UsernamePasswordAuthenticationToken.class)))
                .thenReturn(Mono.error(new ResponseStatusException(HttpStatus.UNAUTHORIZED, "Authentication failed")));
